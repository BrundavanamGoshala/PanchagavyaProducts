...
productNote:"Note",
//---------about product--------
productNameForTranslation:"Amrutha Dhara",
usesOfProductForTranslation:"Relieves Stomach Pain | Bloating | Belching | Gas | Vomiting | Diarrhea | Cold | Cough | Body Pains",
//------ingredients------

ingredientsOneForTranslation:'Mint flower',
ingredientsTwoForTranslation:'Ajwain flower',
ingredientsThreeForTranslation:'Green Camphor',


//--------uses-------
useOneForTranslation:'Relieves Stomach Pain',
useTwoForTranslation:'Bloating',
useThreeForTranslation:'Belching',
useFourForTranslation:'Gas',
useFiveForTranslation:'Vomiting',

useSixForTranslation:'Diarrhea',

useSevenForTranslation:'Cold',

useEightForTranslation:'Cough',

useNineForTranslation:'Body Pains',

//-------benefits----
benefitOneForTranslation:'Add 2 drops in half glass warm water, mix and drink.',
benefitTwoForTranslation:'Or add 1 spoon of amritadhara to 2 spoons of warm sesame oil/coconut oil and mix well and apply externally on wound',
//-------note----
...
ingredientsThreeForTranslation:'పచ్చ కర్పూరం',

//--------uses-------
useOneForTranslation:'కడుపునొప్పి',
useTwoForTranslation:'ఉబ్బరం',
useThreeForTranslation:'పుల్లటి తేనుపులు',
useFourForTranslation:'గ్యాస్',
useFiveForTranslation:'వాంతులు',

useSixForTranslation:'విరేచనాలు',

useSevenForTranslation:'జలుబు',

useEightForTranslation:'దగ్గు',

useNineForTranslation:'ఒళ్ళు నొప్పులు నివారణ',
//-------benefits----
benefitOneForTranslation:'సగం గ్లాసు గోరువెచ్చని నీటిలో 2 చుక్కలు అమృత ధారను కలిపి త్రాగాలి ',
benefitTwoForTranslation:'రెండు చెంచాల గోరు వెచ్చని నువ్వుల నూనె/కొబ్బరి నూనెలో ఒక చెంచా అమృత ధార కలిపి నొప్పి ఉన్నచోట రాయాలి.',
//-------note----
noteOneForTranslation:'10 సం||లు పైబడిన వారు వాడవచ్చును,గర్భిణీ స్త్రీలు వాడకూడదు.',
