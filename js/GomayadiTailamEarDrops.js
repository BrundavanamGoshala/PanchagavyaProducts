...
//---------about product--------
productNameForTranslation:"Gomayadi Tailam Ear Drops",
usesOfProductForTranslation:"Ear-related infections | boils | sores & for pain relief in ear | reducing side effects of radiation caused by mobile phones.",
sesameoilForTranslation:'Sesame oil',
cowdungjuiceForTranslation:'Cow dung juice',
sabjajuiceForTranslation:'Sabja juice',
//--------uses-------
useOneForTranslation:'Works for any ear-related infections',
useTwoForTranslation:'Boils',
useThreeForTranslation:'Sores & For pain relief in ear',
useFourForTranslation:'Will help in reducing side effects of radiation caused by mobile phones',
//-------benefits----
benefitOneForTranslation:'Put 2 drops in the effected ear.',
},
  tel: {
...
sabjajuiceForTranslation:'రుద్రజడ రసం',
//--------uses-------
useOneForTranslation:'చెవికి సంబంధించిన ఎటువంటి వ్యాధులకైనా పని చేస్తుంది',
useTwoForTranslation:'చెవిలో కురుపులు',
useThreeForTranslation:'పుండ్లు వంటి సమస్యలకు,చెవి పోటుకి అద్భుతంగా పనిచేయును.',
useFourForTranslation:'మొబైల్ ఫోన్ల రేడియేషన్ వల్ల కలిగే దుష్ప్రభావాలను తగ్గించడంలో సహాయపడుతుంది',
//-------benefits----
benefitOneForTranslation:'సమస్య ఉన్న చెవిలో 2 చుక్కలు వేసుకోవాలి',
},
};
