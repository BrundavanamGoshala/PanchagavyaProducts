...
logoBrundavanam: "BRUNDAVANAM",
  ...
  gauDharaLinkHeader:"Gau Dhara",
      // homeLinkHeader: "Home",
      // productsLinkHeader:" / Products",
      // gauDharaLinkHeader:" / Gau Dhara Universal Pain Relief Oil",
...
stepThree:"Step - 3",
//-------about product----------
gauDharaInAboutProduct:"Gau Dhara Universal Pain Relief Oil",
usesOfGauDhara:"Cold | Headache | Burns & all kinds of pain",
mrpOfGaudhara:"(MRP inclusive of taxes)",
ingredientsOfGaudhara:"Ingredients",
usesOfGaudhara:"Uses",
//--------ingredients---
pureDesiCowGhee:"Pure Desi Cow Ghee",
peppermint:"Peppermint",
fenugreek:"Fenugreek",
camphor:"Camphor",
eucalyptusOil:"Eucalyptus oil",
tulsiOil:"Tulsi oil",
cloveOil:"Clove oil",
...
headache:"Headache",
burns:"Burns",
allKindsOfPain:"All kinds of pain",
...
stepThree:"దశ - 3",
//------------about product-------
gauDharaInAboutProduct:"గోధార యూనివర్సల్ పెయిన్ రిలీఫ్ ఆయిల్",
usesOfGauDhara:"జలుబు | తలనొప్పి | కాలిన గాయాలకు & అన్ని రకాల నెప్పులకు",
mrpOfGaudhara:"(పన్నులతో కూడిన MRP)",
ingredientsOfGaudhara:"ఉపయోగించిన పదార్థాలు",
usesOfGaudhara:"ఉపయోగాలు",
//------ingredients------
pureDesiCowGhee:"స్వచ్ఛమైన దేశీ ఆవు నెయ్యి",
peppermint:"పుదీనా పువ్వు",
fenugreek:"వాము పువ్వు",
camphor:"పచ్చకర్పూరం",
eucalyptusOil:"నీలగిరి తైలం",
tulsiOil:"తులసి తైలం",
cloveOil:"లవంగం తైలం",
lemongrassOil:"నిమ్మగడ్డి తైలం",
//--------uses------
cold:"జలుబు",
headache:"తలనొప్పి",
burns:"కాలిన గాయాలకు",
allKindsOfPain:"అన్ని రకాల నొప్పులకు పనిచేయును",
...
//----------about products------
const gauDharaInAboutProduct=document.getElementById("gauDharaInAboutProduct");
const usesOfGauDhara=document.getElementById("usesOfGauDhara");
const mrpOfGaudhara=document.getElementById("mrpOfGaudhara");
const ingredientsOfGaudhara=document.getElementById("ingredientsOfGaudhara");
//-------ingredients------
const usesOfGaudhara=document.getElementById("usesOfGaudhara");
const pureDesiCowGhee=document.getElementById("pureDesiCowGhee");
const peppermint=document.getElementById("peppermint");
const fenugreek=document.getElementById("fenugreek");
const camphor=document.getElementById("camphor");
const eucalyptusOil=document.getElementById("eucalyptusOil");
const tulsiOil=document.getElementById("tulsiOil");
const cloveOil=document.getElementById("cloveOil");
const lemongrassOil=document.getElementById("lemongrassOil");
//-------uses-------
const cold=document.getElementById("cold");
const headache=document.getElementById("headache");
const burns=document.getElementById("burns");
const allKindsOfPain=document.getElementById("allKindsOfPain");
const setLanguage = (language) => {
    ...
    gauDharaLinkHeader.innerText=content.gauDharaLinkHeader;
     ...
     //-------about products------
     gauDharaInAboutProduct.innerText=content.gauDharaInAboutProduct;
     usesOfGauDhara.innerText=content.usesOfGauDhara;
     mrpOfGaudhara.innerText=content.mrpOfGaudhara;
     ingredientsOfGaudhara.innerText=content.ingredientsOfGaudhara;
     usesOfGaudhara.innerText=content.usesOfGaudhara;
     //--------ingredients------
     pureDesiCowGhee.innerText=content.pureDesiCowGhee;
     peppermint.innerText=content.peppermint;
     fenugreek.innerText=content.fenugreek;
     camphor.innerText=content.camphor;
     eucalyptusOil.innerText=content.eucalyptusOil;
     tulsiOil.innerText=content.tulsiOil;
     cloveOil.innerText=content.cloveOil;
     lemongrassOil.innerText=content.lemongrassOil;
     //-------uses------
     cold.innerText=content.cold;
     headache.innerText=content.headache;
     burns.innerText=content.burns;
     allKindsOfPain.innerText=content.allKindsOfPain;
//---------for  tabs-----
